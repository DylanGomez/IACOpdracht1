 ...
 * 
 */
@WebServiceClient(name = "mijnService", targetNamespace = "http://dylangomezvazquez/AccuLaden", wsdlLocation = "file:/C:/Users/dylan/IdeaProjects/PraktijkOpdracht1/src/wsdlAccu.wsdl")
    ...
    extends Service
{
    ...
    private final static QName MIJNSERVICE_QNAME = new QName("http://dylangomezvazquez/AccuLaden", "mijnService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/dylan/IdeaProjects/PraktijkOpdracht1/src/wsdlAccu.wsdl");
    ...
    public WSInterface getWSPort() {
        return super.getPort(new QName("http://dylangomezvazquez/AccuLaden", "WS-Port"), WSInterface.class);
    }
    ...
    public WSInterface getWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dylangomezvazquez/AccuLaden", "WS-Port"), WSInterface.class, features);
    }
